  ...
  Widget build(BuildContext context) {
    return Consumer<HomeProvider>(
      builder: (context,homeProv,child){
        return homeProv.data2==null?Center(child: CircularProgressIndicator(color: Colors.blue,),):
          GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 4.0,
                childAspectRatio: .8),
            itemCount:homeProv.data2!.data!.products!.length,
                ...
                child: Column(
                  children: [
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.fill,
                                image:homeProv.data2!.data!.products![index].image.toString() == null
                                    ? NetworkImage(
                                    "https://cutz.com.eg/uploads/product_images/default.png")
                                    : NetworkImage(
                                    homeProv.data2!.data!.products![index].image.toString()),
                              ),
                            )),
                        Positioned(
                            right: 10,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    homeProv.data2!.data!.products![index].discount.toString() == null
                                        ? "0%"
                                        : homeProv.data2!.data!.products![index].discount.toString()+"%",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 11,
                    ...
                    ListTile(
                      isThreeLine: false,
                      title: Text(
                        homeProv.data2!.data!.products![index].name.toString(),
                        maxLines: 1,
                      ),
                      subtitle: Text(
                        homeProv.data2!.data!.products![index].name.toString(),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Column(
                            children: [
                              homeProv.data2!.data!.products![index].price.toString()==null
                                  ? SizedBox()
                                  : Row(
                                children: [
                                  Text("EGP"),
                                  ...
                                  Text("${ homeProv.data2!.data!.products![index].price.toString()}"),
                                ],
                              ),
                              Row(
                                children: [
                                  ...
                                  Text(
                                    homeProv.data2!.data!.products![index].oldPrice.toString()== null
                                        ? ""
                                        :  homeProv.data2!.data!.products![index].oldPrice.toString(),
                                    style: TextStyle(
